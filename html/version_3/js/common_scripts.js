...
// Initialize Variables
   ...
   // Change select data cost on each change to current selected value
	...
	//Update Field Labels and Pricing	
	 ...
	 $( "#order_summary").append('<div id="order_details"></div><div id="price_total"><h3>' + settings.totallabel + ' </h3><label id="total_value"> ' + settings.currency + $.number(total,2) + ' </label></div>');	
